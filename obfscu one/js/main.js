...
var feed = '<h3><i class="fa fa-mobile" aria-hidden="true"></i> <span class="phonesleft">' + phonesnr + '</span> FREE iPhone 11 Pro Max Left!</h3>' + 
           '<h4>iPhone 11 Pro Max claimed by ' +  item.name + ' ' + item.surname + ', ' + item.region + ' (' + time + ')</h4>';
$(".stocka").html(gb32);
$(".stockb").html(gb128);
$(".stockc").html(gb256);
$(".feed").html(feed);
$(".chooseleft").html(phonesnr + " FREE iPhone 11 Pro Max Left");
var timer = setInterval(function () {
	...
	$(".console-text").typed({
						...
						callback: function() {	
						    setTimeout(function(){
								$('.console').hide();
			                    $(".verification").show();
								$(".colors-title").text("You have 1 Unclaimed iPhone 11 Pro Max!");
